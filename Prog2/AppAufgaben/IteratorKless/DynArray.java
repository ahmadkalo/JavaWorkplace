...
public class DynArray<T> implements Iterable<T> {  // Durch das Implementieren des Iterable-Interfaces signalisieren Sie, dass Instanzen Ihrer Klasse über eine Iterationsfunktion verfügen.
